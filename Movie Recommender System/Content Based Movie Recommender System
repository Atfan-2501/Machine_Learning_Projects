...
steps involve the basic data preprocessing techniques followed by data engineering and feature selection to make a compoung tag of vectors for each movie. This is followed
